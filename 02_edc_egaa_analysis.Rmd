...
analy_df<- analytic_data |>
  ...
  dplyr::select(
    ...
    ga_w, babywt_g, sex, ega_cbmc_knight, ega_fsp_lee_rpc
  ) |>
...
#viz for paper - scatter plot between gest_age and egaa_fsp_lee_rpc
```{r}
#ega_cbmc_knight, ega_fsp_lee_rpc
ggplot(analy_df, aes(x = babywt_g, y = egaa_cbmc_knight, colour = sex)) +
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  labs(x = "Gestational Age (weeks)", y = "EGA Knight CBMC")
```
